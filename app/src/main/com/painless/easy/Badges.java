...
import com.painless.easy.actors.mobs.Senior;
import com.painless.easy.actors.mobs.Shielded;
import com.painless.easy.items.Item;
import com.painless.easy.items.bags.ScrollHolder;
import com.painless.easy.items.bags.SeedPouch;
import com.painless.easy.items.bags.WandHolster;
import com.painless.easy.items.potions.Potion;
import com.painless.easy.items.rings.Ring;
import com.painless.easy.items.rings.RingOfHaggler;
...
import com.painless.easy.scenes.PixelScene;
...
public class Badges {
	...
	public static enum Badge {
        ...
        RATE_NOW( "Thanks for the good rating!", 31, true ),
        RATE_LATER( "Your feedback was appreciated.", 31, true),
        RATE_LATER_NEVER( "Your feedback was appreciated..", 31, true),
        RATE_BAD( "Your feedback was appreciated!", 31, true),
        RATE_BAD_HEAVY( "Your feedback was appreciated!!", 31, true);
    ...
    public static void validateRateNow() {

        global.add( Badge.RATE_NOW );
        saveNeeded = true;

        PixelScene.showBadge( Badge.RATE_NOW );
    }

    public static void validateRateLater() {

        global.add( Badge.RATE_LATER );
        saveNeeded = true;
    }

    public static void validateRateLaterNever() {

        global.add( Badge.RATE_LATER_NEVER );
        saveNeeded = true;
    }

    public static void validateRateBad() {

        global.add( Badge.RATE_BAD);
        saveNeeded = true;
    }

    public static void validateRateBadHeavy() {

        global.add( Badge.RATE_BAD_HEAVY);
        saveNeeded = true;
    }
