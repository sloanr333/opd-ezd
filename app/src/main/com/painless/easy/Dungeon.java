...
import com.painless.easy.actors.buffs.Amok;
...
import com.painless.easy.actors.mobs.npcs.Blacksmith;
import com.painless.easy.actors.mobs.npcs.Imp;
import com.painless.easy.actors.mobs.npcs.Ghost;
import com.painless.easy.actors.mobs.npcs.Wandmaker;
import com.painless.easy.items.Ankh;
import com.painless.easy.items.potions.Potion;
import com.painless.easy.items.rings.Ring;
import com.painless.easy.items.scrolls.Scroll;
import com.painless.easy.items.wands.Wand;
import com.painless.easy.levels.CavesBossLevel;
import com.painless.easy.levels.CavesLevel;
import com.painless.easy.levels.CityBossLevel;
import com.painless.easy.levels.CityLevel;
import com.painless.easy.levels.DeadEndLevel;
import com.painless.easy.levels.HallsBossLevel;
import com.painless.easy.levels.HallsLevel;
import com.painless.easy.levels.LastLevel;
import com.painless.easy.levels.LastShopLevel;
import com.painless.easy.levels.Level;
import com.painless.easy.levels.PrisonBossLevel;
import com.painless.easy.levels.PrisonLevel;
import com.painless.easy.levels.Room;
import com.painless.easy.levels.SewerBossLevel;
import com.painless.easy.levels.SewerLevel;
import com.painless.easy.scenes.GameScene;
import com.painless.easy.scenes.StartScene;
import com.painless.easy.utils.BArray;
import com.painless.easy.utils.Utils;
...
public class Dungeon {
	...
	public static Level newLevel() {
		...
		if (depth > Statistics.deepestFloor) {
            //Game.TrackEvent("Game Play", "Level Achieved", Integer.toString(depth));
	...
	private static final String RG_GAME_FILE	= "easy-game.dat";
	private static final String RG_DEPTH_FILE	= "easy-depth%d.dat";
	
	private static final String WR_GAME_FILE	= "easy-warrior.dat";
	private static final String WR_DEPTH_FILE	= "easy-warrior%d.dat";
	
	private static final String MG_GAME_FILE	= "easy-mage.dat";
	private static final String MG_DEPTH_FILE	= "easy-mage%d.dat";
	
	private static final String RN_GAME_FILE	= "easy-ranger.dat";
	private static final String RN_DEPTH_FILE	= "easy-ranger%d.dat";
	...
	public static void saveGame( String fileName ) throws IOException {
		try {
			...
			bundle.put( VERSION, OPDGame.subVersion );
