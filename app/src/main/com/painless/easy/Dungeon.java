...
public class Dungeon {
	...
	public static Level newLevel() {
		...
		if (depth > Statistics.deepestFloor) {
			// Game.TrackEvent("Game Play", "Level Achieved",
	...
	public static void saveGame(String fileName) throws IOException {
		try {
			...
			OutputStream output = OPDGame.openDatOutput(fileName,
					Game.MODE_PRIVATE);
	...
	public static void saveAll() throws IOException {
		if (hero.isAlive()) {
			...
			GamesInProgress.set(hero.heroClass, depth, hero.lvl,
					hero.belongings.armor != null ? hero.belongings.armor.tier
							: 0);
	...
	public static Level loadLevel(HeroClass cl) throws IOException {
		...
		InputStream input = OPDGame.openDatInput(Utils.format(depthFile(cl),
				depth));
	...
	public static void preview(GamesInProgress.Info info, Bundle bundle) {
		...
		if (info.depth == -1) {
			info.depth = bundle.getInt("maxDepth"); // <-- It has to be
													// refactored!
		}
