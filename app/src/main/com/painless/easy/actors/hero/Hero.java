 ...
 */
package com.painless.easy.actors.hero;
...
import com.painless.easy.Bones;
import com.painless.easy.Dungeon;
import com.painless.easy.GamesInProgress;
import com.painless.easy.actors.Actor;
import com.painless.easy.actors.Char;
import com.painless.easy.actors.buffs.Barkskin;
import com.painless.easy.actors.buffs.Bleeding;
import com.painless.easy.actors.buffs.Blindness;
import com.painless.easy.actors.buffs.Buff;
import com.painless.easy.actors.buffs.Burning;
import com.painless.easy.actors.buffs.Combo;
import com.painless.easy.actors.buffs.Cripple;
import com.painless.easy.actors.buffs.Fury;
import com.painless.easy.actors.buffs.GasesImmunity;
import com.painless.easy.actors.buffs.Hunger;
import com.painless.easy.actors.buffs.Invisibility;
import com.painless.easy.actors.buffs.Light;
import com.painless.easy.actors.buffs.Ooze;
import com.painless.easy.actors.buffs.Paralysis;
import com.painless.easy.actors.buffs.Poison;
import com.painless.easy.actors.buffs.Regeneration;
import com.painless.easy.actors.buffs.Roots;
import com.painless.easy.actors.buffs.Charm;
import com.painless.easy.actors.buffs.SnipersMark;
import com.painless.easy.actors.buffs.Weakness;
import com.painless.easy.actors.mobs.Mob;
import com.painless.easy.effects.CheckedCell;
import com.painless.easy.effects.Flare;
import com.painless.easy.effects.Speck;
import com.painless.easy.items.Amulet;
import com.painless.easy.items.Ankh;
import com.painless.easy.items.DewVial;
import com.painless.easy.items.Dewdrop;
import com.painless.easy.items.Heap;
import com.painless.easy.items.Heap.Type;
import com.painless.easy.items.Item;
import com.painless.easy.items.KindOfWeapon;
import com.painless.easy.items.armor.Armor;
import com.painless.easy.items.keys.GoldenKey;
import com.painless.easy.items.keys.Key;
import com.painless.easy.items.keys.SkeletonKey;
import com.painless.easy.items.keys.IronKey;
import com.painless.easy.items.potions.PotionOfStrength;
import com.painless.easy.items.rings.RingOfAccuracy;
import com.painless.easy.items.rings.RingOfDetection;
import com.painless.easy.items.rings.RingOfElements;
import com.painless.easy.items.rings.RingOfEvasion;
import com.painless.easy.items.rings.RingOfHaste;
import com.painless.easy.items.rings.RingOfShadows;
import com.painless.easy.items.rings.RingOfThorns;
import com.painless.easy.items.scrolls.ScrollOfMagicMapping;
import com.painless.easy.items.scrolls.ScrollOfRecharging;
import com.painless.easy.items.scrolls.ScrollOfUpgrade;
import com.painless.easy.items.wands.Wand;
import com.painless.easy.items.weapon.Weapon;
import com.painless.easy.items.weapon.melee.MeleeWeapon;
import com.painless.easy.levels.Level;
import com.painless.easy.levels.Terrain;
import com.painless.easy.levels.features.AlchemyPot;
import com.painless.easy.levels.features.Chasm;
import com.painless.easy.plants.Earthroot;
import com.painless.easy.scenes.GameScene;
import com.painless.easy.scenes.InterlevelScene;
import com.painless.easy.scenes.SurfaceScene;
...
import com.painless.easy.ui.BuffIndicator;
import com.painless.easy.ui.QuickSlot;
import com.painless.easy.utils.GLog;
import com.painless.easy.windows.WndMessage;
import com.painless.easy.windows.WndResurrect;
import com.painless.easy.windows.WndTradeItem;
import com.watabou.utils.Bundle;
import com.watabou.utils.Random;

public class Hero extends Char {
	
	private static final String TXT_LEAVE = "One does not simply leave Easy Dungeon.";
	...
	public int attackSkill( Char target ) {
		...
		float accuracy = (bonus == 0) ? 1 : (float)Math.pow( 1.5, bonus );
	...
	public int defenseSkill( Char enemy ) {
		...
		if (aEnc > 0) {
			return (int)(defenseSkill * evasion / Math.pow( 1.7, aEnc ));
		} else {
	...
	private void actDescend( HeroAction.Descend action ) {
		...
		if (pos == stairs && pos == Dungeon.level.exit) {
            ...
            {
                //Game.showFullscreen("Monetisation", "Monetize Event", "Descend (Boss)");
            }
            //Game.showFullscreenExtra("Monetisation", "Monetize Event", "Descend (Other)");
	...
	public static void reallyDie( Object cause ) {
		...
		GameScene.gameOver();
        //Game.showFullscreen("Monetisation", "Monetize Event", "Death");
        //Game.TrackEvent("Game Play", "Death", Integer.toString(Dungeon.depth));
	...
	public void resurrect( int resetLevel ) {
        ...
        //Game.showFullscreen("Monetisation", "Monetize Event", "Resurrect");
	}
