...
import com.painless.easy.Chrome;
...
import com.painless.easy.ui.Archs;
import com.painless.easy.ui.Icons;
import com.painless.easy.ui.RedButton;
import com.painless.easy.ui.SimpleButton;
import com.painless.easy.ui.Window;
import com.painless.easy.utils.Utils;
import com.painless.easy.windows.WndList;
import com.painless.easy.windows.WndOptions;
import com.painless.easy.windows.WndTitledMessage;
...
public class StartScene extends PixelScene {
	...
	public void create() {
				...
				if (GamesInProgress.check( curClass ) != null) {
					StartScene.this.add( new WndOptions( TXT_REALLY, TXT_WARNING, TXT_YES, TXT_NO ) {
						...
						protected void onSelect( int index ) {
							if (index == 0) {
                                //Game.TrackEvent("Game Play", "Started Game", curClass.name());
		...
		btnLoad = new GameButton( TXT_LOAD ) {	
			@Override
			protected void onClick() {
                //Game.TrackEvent("Game Play", "Resumed Game", curClass.name());
...
//		}
	...
	private void updateClass( HeroClass cl ) {
		...
		if (cl != HeroClass.HUNTRESS || true/*huntressUnlocked*/) {
